...
Config.Safes = {
    ...
    [5] = {vector3(31.29, -1339.3, 29.5), type = "keypad", robbed = false, camId = 8},
    ...
    [8] = {vector3(381.04, 332.61, 103.57), type = "keypad", robbed = false, camId = 11},
    ...
    [11] = {vector3(-3048.63, 588.57, 7.91), type = "keypad", robbed = false, camId = 14},
    [12] = {vector3(-3249.69, 1007.47, 12.83), type = "keypad", robbed = false, camId = 15},
    [13] = {vector3(543.68, 2662.67, 42.16), type = "keypad", robbed = false, camId = 16},
    [14] = {vector3(1169.31, 2717.79, 37.15), type = "padlock", robbed = false, camId = 17},
    [15] = {vector3(2674.32, 3289.18, 55.24), type = "keypad", robbed = false, camId = 18},
    [16] = {vector3(1961.79, 3750.25, 32.34), type = "keypad", robbed = false, camId = 19},
    [17] = {vector3(1737.43, 6419.42, 35.04), type = "keypad", robbed = false, camId = 20},
    [18] = {vector3(-168.40, 6318.80, 30.58), type = "padlock", robbed = false, camId = 27}, -- Paleto Liquor Store MLO not in
    [19] = {vector3(171.03, 6642.54, 31.7), type = "keypad", robbed = false, camId = 30},
}
